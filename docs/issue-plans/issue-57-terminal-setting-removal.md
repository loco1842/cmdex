...
**Category:** bug _(recategorized from enhancement/question — see TRIAGE.md notes)_ · **Priority:** P2 · **Effort:** L (7 files; revised up from the initial M guess once the full removal scope was grounded) · **Status:** pr-open
...
**PR:** https://github.com/loco1842/cmdex/pull/59
